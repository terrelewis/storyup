...
package tbmp.skeleton;
import tbmp.skeleton.R;
...
public class SkeletonActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStoryView=((TextView) findViewById(R.id.story));
        //mOStoryView=((TextView) findViewById(R.id.ostory));
        mTimer=((TextView) findViewById(R.id.timer_view));
    }
    ...
    private MalibuCountDownTimer countDownTimer= new MalibuCountDownTimer(20000, 1000);
...
// Create a one-on-one automatch game.
    ...
    public void setViewVisibility() {
       ...
       /* else if (isStart && !isDoingTurn){
            findViewById(R.id.gameplay_layout).setVisibility(View.GONE);
            findViewById(R.id.othergameplay_layout).setVisibility(View.VISIBLE);
        }*/
        else {
    ...
    public void setGameplayUI() {
       ...
       // mDataView.setText(mTurnData.data);
        mStoryView.setText(" "+mStoryView.getText().toString()+mTurnData.data);
        mTurnTextView.setText("Turn " + mTurnData.turnCounter);
        mTimer.setText("Time remaining:");
        countDownTimer.start();
    }
   /* public void setOtherGameplayUI() {
       // isDoingTurn = false;
        setViewVisibility();
        // mDataView.setText(mTurnData.data);
        mOStoryView.setText(" "+mOStoryView.getText().toString()+mTurnData.data);
        //mTurnTextView.setText("Turn " + mTurnData.turnCounter);
        //mTimer.setText("Time remaining:");
        //countDownTimer.start();
    }*/
